...
export default {
  ...
  menu: {
    ...
    smartAssistant: 'Hexiaozhi',
    studentAssistant: 'Hexiaozhi Student Assistant',
    teacherAssistant: 'Hexiaozhi Teacher Assistant',
    academicAdminAssistant: 'Hexiaozhi Academic Assistant',
    businessCenter: 'Campus Service Center',
    smartCampusDashboard: 'Smart Campus Dashboard',
    studentAcademic: 'My Courses',
    studentAffairs: 'My Affairs',
    studentLearning: 'Learning Analytics',
    teacherTeaching: 'My Teaching',
    teacherPreparation: 'Teaching Resources',
    teacherAnalysis: 'Learning Analytics',
    academicDashboard: 'Data Dashboard',
    academicServiceManagement: 'Service Management',
    intelligentAgentManagement: 'Agent Management',
    mcpServiceManagement: 'MCP Service Management',
    ...
    campusGovernance: 'Campus Governance',
    publicOpinion: 'Public Opinion Analysis',
    app: {
      index: '应用开发',
      all: '全部',
      agent: '智能体',
  ...
  publicOpinion: {
    title: 'Campus Public Opinion Analysis Center',
    subtitle:
      'Analyze public campus information to identify student concerns, trending events, and potential risks.',
    demoData: 'Demo Data',
    timeRange: 'Time Range',
    lastUpdated: 'Last Updated',
    refresh: 'Refresh',
    refreshSuccess: 'Demo data refreshed',
    realDataRefreshSuccess: 'Public opinion data refreshed',
    ...
    overview: {
      ...
      trendTitle: '7-Day Opinion Trend',
      totalOpinion: 'Total Mentions',
      negativeOpinion: 'Negative Mentions',
      sentimentTitle: 'Sentiment Distribution',
      hotTopics: 'Top 5 Topics',
      riskEvents: 'Top 5 Risk Events',
      latestOpinion: 'Latest Opinions',
      heat: 'Heat',
    },
    sentiment: {
      positive: 'Positive',
    ...
    concern: {
      boundary:
        'This page only shows common concerns aggregated from public content.',
    ...
    alert: {
      title: 'Risk Alert Events',
      description:
        'Public discussion volume, growth, and negative share help prioritize attention.',
      risk: 'Risk',
      heat: 'Heat',
      growth24h: '24h Growth',
      negativeRatio: 'Negative Share',
      reason: 'Main Reason',
    ...
    table: {
      keyword: 'Keyword',
      keywordPlaceholder: 'Search title or topic',
      time: 'Date Range',
      ...
      status: 'Status',
      heat: 'Heat',
      empty: 'No matching demo data',
      realEmpty: 'No public opinion data',
      realEmptyTip:
        'Download the template and use “Import Data” to add records.',
      noViewPermission:
        'Your account does not have permission to view public opinion data',
    },
    import: {
      title: 'Import Campus Public Opinion Data',
      supportedFormats: 'Supports .xlsx / .csv',
      maxFileSize: 'Maximum file size: 5MB',
      maxRows: 'Up to 1,000 records',
      templateTip: 'Download and complete the standard template before import',
      selectFile: 'Drop a file here or click to select one',
      fileLimitTip: 'Only one .xlsx or .csv file is supported',
      ...
      field: 'Field',
      reason: 'Reason',
      errorLimitTip: 'Only the first {count} errors are shown',
      successMessage: 'Public opinion data imported successfully',
      partialMessage: 'Some records were imported. Review the error details.',
      failedMessage: 'Import failed. Review the error details.',
    },
    risk: {
      low: 'Low',
      normal: 'Moderate',
    ...
    analysis: {
      selectPrompt: 'Select an event to begin analysis',
      selectDescription:
        'Event information and structured findings will be presented here in a later phase.',
      eventSummary: 'Event Summary',
      coreNeeds: 'Core Needs',
      emotionAnalysis: 'Sentiment Analysis',
      ...
      modelDescription:
        'This phase displays UI only and does not call models, workflows, or knowledge bases.',
    },
    report: {
      description:
        'Reports currently use demo data. File export is not available.',
      name: 'Report Name',
      type: 'Report Type',
      ...
      previewTip: 'Report preview is not available in phase one',
      generateTip: 'Real reports are not generated in phase one',
    },
  },
  header: {
