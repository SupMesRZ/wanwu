...
export default {
  ...
  menu: {
    smartCampus: '智慧校园',
    smartAssistant: '河小智',
    studentAssistant: '河小智学生助手',
    teacherAssistant: '河小智教师助手',
    academicAdminAssistant: '河小智教务助手',
    businessCenter: '校园业务中心',
    smartCampusDashboard: '智慧校园管理中心',
    studentAcademic: '我的课程',
    studentAffairs: '我的事务',
    studentLearning: '学习分析',
    teacherTeaching: '我的教学',
    teacherPreparation: '教学资源',
    teacherAnalysis: '学情分析',
    academicDashboard: '数据驾驶舱',
    academicServiceManagement: '服务管理',
    intelligentAgentManagement: '智能体管理',
    mcpServiceManagement: 'MCP服务管理',
    dataStatistics: '数据统计',
  ...
  publicOpinion: {
    title: '校园舆情研判中心',
    subtitle: '面向校园公开信息，辅助发现学生关切、热点事件和潜在风险。',
    demoData: '演示数据',
    timeRange: '时间范围',
    lastUpdated: '最近更新时间',
    refresh: '刷新',
    refreshSuccess: '演示数据已刷新',
    realDataRefreshSuccess: '真实舆情数据已刷新',
    ...
    overview: {
      ...
      hotEvents: '热点事件',
      risksToWatch: '待关注风险',
      studentConcerns: '学生关切',
      comparedYesterday: '较昨日',
      comparedLastWeek: '较上周',
      trendTitle: '近7日舆情趋势',
      totalOpinion: '总舆情',
      negativeOpinion: '负向舆情',
      sentimentTitle: '情感分布',
      hotTopics: '热点话题 Top 5',
      riskEvents: '风险事件 Top 5',
      latestOpinion: '最新舆情',
      heat: '热度',
    },
    sentiment: {
    ...
    alert: {
      title: '风险预警事件',
      description: '结合公开讨论热度、增速和负向占比，辅助确定关注优先级。',
      risk: '风险',
      heat: '热度',
      growth24h: '24h增长',
      negativeRatio: '负向占比',
    ...
    table: {
      ...
      empty: '暂无符合条件的演示数据',
      realEmpty: '暂无真实舆情数据',
      realEmptyTip: '可下载模板并通过“导入数据”添加数据。',
      noViewPermission: '当前账号没有查看舆情列表的权限',
    },
    import: {
      title: '导入校园舆情数据',
      supportedFormats: '支持 .xlsx / .csv',
      maxFileSize: '单文件最大 5MB',
      maxRows: '最多 1000 条数据',
      templateTip: '请优先下载标准模板填写后再导入',
      selectFile: '将文件拖到此处，或点击选择文件',
      fileLimitTip: '仅支持单个 .xlsx 或 .csv 文件',
      singleFileOnly: '只允许选择一个文件',
      noFile: '请选择文件',
      ...
      field: '字段',
      reason: '失败原因',
      errorLimitTip: '错误较多，仅展示前 {count} 条',
      successMessage: '舆情数据导入成功',
      partialMessage: '部分数据导入成功，请查看错误详情',
      failedMessage: '舆情数据导入失败，请查看错误详情',
    },
    risk: {
      low: '低',
      normal: '一般',
    ...
    analysis: {
      selectPrompt: '选择一个舆情事件开始研判',
      selectDescription: '后续可在此查看事件信息并形成结构化研判意见。',
      eventSummary: '事件摘要',
      coreNeeds: '核心诉求',
    ...
    report: {
      description: '报告功能当前使用演示数据，暂不提供文件导出。',
      name: '报告名称',
      type: '报告类型',
      generatedAt: '生成时间',
      status: '状态',
      preview: '预览',
      generate: '生成报告',
      previewTip: '第一阶段暂不提供报告预览',
      generateTip: '第一阶段暂不生成真实报告',
    },
  },
  header: {
